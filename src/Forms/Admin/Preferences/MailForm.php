...
class MailForm extends BaseForm {
	...
	protected function createForm() {
        ...
        $smtp = $this->config->existsNode('smtp')
            ? $this->config->getNode('smtp')
            : $this->getEmptySMTPNode();
		$this->form
    ...
    protected function processForm() {
        ...
        $this->config->getNode('sender')
            ->set('name', $this->form->getValue('from_name'))
            ->set('email', $this->form->getValue('from_email'));
        ...
        if ($this->form->getValue('transport_type') === 'smtp') {
            ...
            $this->config->getNode('smtp')
                ->set('host', $this->form->getValue('smtp_host'))
                ->set('port', (int) $this->form->getValue('smtp_port'))
                ->set('secure', $this->form->getValue('smtp_secure'))
                ->set('username', $this->form->getValue('smtp_user'))
                ->set('password', $this->form->getValue('smtp_pass'));
        }
